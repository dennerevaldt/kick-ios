//
//  PlayerGamesNearTvController.swift
//  kickoff
//
...
class PlayerGamesNearTvController: UITableViewController, DZNEmptyDataSetSource, DZNEmptyDataSetDelegate {
    private var gamesList: Array<String> = Array()
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cellIdentifier: String = "gamesListCell"
    ...
    func descriptionForEmptyDataSet(scrollView: UIScrollView!) -> NSAttributedString! {
        ...
        //        }
        let attrString = NSAttributedString (
            string: "Você está longe de todos jogos!",
            attributes: [
